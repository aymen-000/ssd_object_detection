...
def main():
    ...
    if args.fine_tune:
        ...
        valid_data = AminiCocoaDataset(image_root=args.data_folder,  df=val_df, split="val")
        train_data = AminiCocoaDataset(image_root=args.data_folder, df=train_df, split="train")
